...
export class ZgetVault extends ZgetBase {
  constructor() {
    ...
    this.PLATFORM_ICONS = {
      ...
      'c-span': `<svg width="16" height="16" viewBox="0 0 24 24" fill="#FFFFFF"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm4.5-12.2L12 12 7.5 7.8l-1.4 1.4L10.6 13.5l-4.5 4.3 1.4 1.4L12 15l4.5 4.2 1.4-1.4-4.5-4.3 4.5-4.3-1.4-1.4z"/></svg>`,
    };
  }
